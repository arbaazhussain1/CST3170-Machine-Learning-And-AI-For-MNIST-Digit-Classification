...
public class MachineLearningPipeline {
    ...
    public static void main(String[] args) {
        ...
        dataPreprocessor.splitDataset(trainingFeaturesDataset1, trainingLabelsDataset1, fold1Features, fold1Labels, fold2Features, fold2Labels);
        ...
        double accuracyOfKNN = classifierEvaluator.evaluateKNN(knn, fold1Features, fold1Labels, fold2Features, fold2Labels);
        ...
        double accuracyOfUnifiedClassifier = classifierEvaluator.evaluateUnifiedClassifier(fold1Features, fold1Labels, fold2Features, fold2Labels, svm, mlp);
